const DEFAULT_SALE_NAME = "Black Friday";
const DEFAULT_SALE_PERCENT = 30;
const MIN_PERCENT = 0;
const MAX_PERCENT = 100;

const parsedPercent = Number(
  import.meta.env.VITE_BLACK_FRIDAY_PERCENT ?? import.meta.env.VITE_SALE_PERCENT
);
...
const rawSaleName =
  import.meta.env.VITE_BLACK_FRIDAY_NAME ??
  import.meta.env.VITE_SALE_EVENT_NAME ??
  "";
